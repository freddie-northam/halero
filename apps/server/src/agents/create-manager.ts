...
export const createAgentRunManager = (
  ...
  // as agent.run entities (searchable/linkable/timeline-able), with their
  // outcome persisted to the agent_runs satellite so it survives a restart.
