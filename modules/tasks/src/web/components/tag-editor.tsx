...
/**
 * Add/remove chips for a task's tags; duplicates and blanks are ignored.
 * The add field is uncontrolled (read straight off the DOM node, the
 * app's established text-input pattern) and cleared imperatively after
 * a successful add, rather than through a controlled value.
 */
