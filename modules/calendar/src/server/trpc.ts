// The calendar module's own tRPC instance, built against the request
...
// mounts the module router under modules.calendar.*.
...
/** Every calendar procedure requires a signed-in session. */
