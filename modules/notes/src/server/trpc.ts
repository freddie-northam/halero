// The notes module's own tRPC instance, built against the request
...
// mounts the module router under modules.notes.*.
...
/** Every notes procedure requires a signed-in session. */
